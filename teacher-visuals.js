...
gc.addEventListener("mouseenter",()=>{
  ...
  h.style.color="#1E1208";
  h.style.textShadow="0 0 12px rgba(30,18,8,0.4), 0 0 28px rgba(30,18,8,0.2)";
...
function drawDynamicConnector(){
  ...
  ghctx.save();
  ghctx.strokeStyle="#F0E6DC"; ghctx.lineWidth=1.2; ghctx.setLineDash([4,3]);
  ghctx.beginPath();
  ...
  ghctx.fillStyle="#F0E6DC"; ghctx.fill();
  ghctx.restore();
}
...
const COLORS = {sq:"#F0E6DC",tri:"#E8622A",ci:"#F0E6DC"};
...
function globeLoop(){
  ...
  gctx.fillStyle="#1E1208";gctx.fill();
  gctx.strokeStyle="rgba(240,230,220,0.15)";gctx.lineWidth=1;gctx.stroke();
...
function spiroLoop(){
  ...
  sctx.fillStyle="#1E1208";sctx.fill();
  ...
  sctx.strokeStyle="rgba(240,230,220,0.18)";sctx.lineWidth=1;sctx.stroke();
  ...
  sctx.strokeStyle=`rgba(240,230,220,${(0.04+iv*0.28).toFixed(2)})`;
  ...
  sctx.strokeStyle=`rgba(240,230,220,${(0.08+iv*0.22).toFixed(2)})`;
