        ...
        (function(){
            ...
            style.textContent = '@keyframes glisten{0%,100%{text-shadow:0 0 10px rgba(30,18,8,0.3),0 0 24px rgba(30,18,8,0.15)}40%{text-shadow:0 0 20px rgba(30,18,8,0.7),0 0 40px rgba(30,18,8,0.4),0 0 60px rgba(30,18,8,0.2)}}.glisten{animation:glisten 1.6s ease-in-out infinite;}';
            document.head.appendChild(style);
            document.getElementById('hero-type-text').textContent = "Seek2lrn gives teachers a global stage. Set your pace, your subjects, your rates — and reach learners anywhere in the world.";
        ...
        function showTeacherView() {
            ...
            setTimeout(() => {
                ...
                // background stays orange — no change
        ...
        function showPage(id) {
            ...
            if (id === 'home') {
                ...
                if (heroTypeText) heroTypeText.style.color = 'rgba(30,18,8,0.55)';
            }
            window.scrollTo({ top: 0, behavior: 'smooth' });
